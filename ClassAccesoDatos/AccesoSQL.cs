...
namespace ClassAccesoDatos
{
    public class AccesoSQL
    {
        ...
        //public Boolean InsertaEmpleadoConParametros(string sentenciaSQL, SqlConnection cn,
        //                                            ref string mensaje,
        //                                            SqlParameter parametro1,
        ...
        public Boolean ModificiaParametros(string sentenciaSQL, SqlConnection cn,
                                                    ref string mensaje,
